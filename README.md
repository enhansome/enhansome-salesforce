...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,419 | 🐛 106 | 📅 2026-09-02
...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,419 | 🐛 106 | 📅 2026-09-02 list thing. You might also like to read complete [awesome-list](https://github.com/sindresorhus/awesome) ⭐ 507,419 | 🐛 106 | 📅 2026-09-02.*
...
Read [the awesome manifesto](https://github.com/mailtoharshit/awesome-salesforce/blob/master/contributing.md) ⭐ 805 | 🐛 8 | 📅 2023-07-20 and ensure your list complies.
...
* Visual Studio Code
  * [Salesforce Extensions for VS Code](https://github.com/forcedotcom/salesforcedx-vscode) ⭐ 1,035 | 🐛 91 | 🌐 TypeScript | 📅 2026-09-18 are the official Salesforce VS Code extensions.
...
* [Apex Commons](https://github.com/financialforcedev/fflib-apex-common) ⭐ 1,012 | 🐛 36 | 🌐 Apex | 📅 2026-09-18 - Common Apex Library supporting Apex Enterprise Patterns and much more!
...
* [Apex Commons Sample Code](https://github.com/financialforcedev/fflib-apex-common-samplecode) ⭐ 220 | 🐛 11 | 🌐 Apex | 📅 2026-09-08 - Samples application illustrating the Apex Enterprise Patterns library
  Must deploy [Apex Common ](https://github.com/financialforcedev/fflib-apex-common) ⭐ 1,012 | 🐛 36 | 🌐 Apex | 📅 2026-09-18 before deploying this library<br/> <a href="https://githubsfdeploy.herokuapp.com?owner=financialforcedev&repo=fflib-apex-common-samplecode"><img alt="Deploy to Salesforce" src="https://raw.githubusercontent.com/afawcett/githubsfdeploy/master/src/main/webapp/resources/img/deploy.png">
  </a>
...
* [SoqlXplorer](https://github.com/superfell/SoqlX) ⭐ 280 | 🐛 19 | 🌐 Objective-C | 📅 2023-08-20- SoqlXplorer is an awesome tool for developers using the Salesforce.com platform.
...
* [Salesfoce MobileSDK for Andriod](https://github.com/forcedotcom/SalesforceMobileSDK-Android) ⭐ 361 | 🐛 7 | 🌐 Kotlin | 📅 2026-09-17- Source repository for the Salesforce Mobile SDK for Android.
...
Contributions welcome! Read the [contribution guidelines](https://github.com/mailtoharshit/awesome-salesforce/blob/master/contributing.md) ⭐ 805 | 🐛 8 | 📅 2023-07-20 first.
