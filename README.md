...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,310 | 🐛 105 | 📅 2026-09-02 list thing. You might also like to read complete [awesome-list](https://github.com/sindresorhus/awesome) ⭐ 502,310 | 🐛 105 | 📅 2026-09-02.*
...
Read [the awesome manifesto](https://github.com/mailtoharshit/awesome-salesforce/blob/master/contributing.md) ⭐ 804 | 🐛 6 | 📅 2023-07-20 and ensure your list complies.
...
* Visual Studio Code
  * [Salesforce Extensions for VS Code](https://github.com/forcedotcom/salesforcedx-vscode) ⭐ 1,033 | 🐛 107 | 🌐 TypeScript | 📅 2026-09-02 are the official Salesforce VS Code extensions.
...
* [Apex Commons](https://github.com/financialforcedev/fflib-apex-common) ⭐ 1,012 | 🐛 37 | 🌐 Apex | 📅 2026-08-29 - Common Apex Library supporting Apex Enterprise Patterns and much more!
...
* [Apex Commons Sample Code](https://github.com/financialforcedev/fflib-apex-common-samplecode) ⭐ 219 | 🐛 11 | 🌐 Apex | 📅 2026-08-27 - Samples application illustrating the Apex Enterprise Patterns library
  Must deploy [Apex Common ](https://github.com/financialforcedev/fflib-apex-common) ⭐ 1,012 | 🐛 37 | 🌐 Apex | 📅 2026-08-29 before deploying this library<br/> <a href="https://githubsfdeploy.herokuapp.com?owner=financialforcedev&repo=fflib-apex-common-samplecode"><img alt="Deploy to Salesforce" src="https://raw.githubusercontent.com/afawcett/githubsfdeploy/master/src/main/webapp/resources/img/deploy.png">
  </a>
...
* [Workbench](https://github.com/ryanbrainard/forceworkbench) ⭐ 536 | 🐛 2 | 🌐 PHP | 📅 2026-07-25- Workbench is a powerful, web-based suite of tools designed for administrators and developers to interact with Salesforce.com organizations via the Force.com APIs.
...
* [soql-parser-js](https://github.com/paustint/soql-parser-js) ⭐ 89 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-31 - JavaScript library for parsing SOQL queries, composing SOQL queries, and formatting SOQL queries.
...
* Some other solutions from [awesome-etl list](https://github.com/pawl/awesome-etl) ⭐ 3,589 | 🐛 12 | 📅 2026-05-01.
...
* [Salesfoce MobileSDK for iOS](https://github.com/forcedotcom/SalesforceMobileSDK-iOS) ⭐ 555 | 🐛 6 | 🌐 Objective-C | 📅 2026-09-02-If you'd like to work with the source code of the SDK itself, you've come to the right place! You can browse sample app source code and debug down through the layers to get a feel for how everything works under the covers.

* [Salesfoce MobileSDK for Andriod](https://github.com/forcedotcom/SalesforceMobileSDK-Android) ⭐ 361 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-02- Source repository for the Salesforce Mobile SDK for Android.
...
Contributions welcome! Read the [contribution guidelines](https://github.com/mailtoharshit/awesome-salesforce/blob/master/contributing.md) ⭐ 804 | 🐛 6 | 📅 2023-07-20 first.
