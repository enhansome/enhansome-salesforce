...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,082 | 🐛 106 | 📅 2026-09-02 list thing. You might also like to read complete [awesome-list](https://github.com/sindresorhus/awesome) ⭐ 507,082 | 🐛 106 | 📅 2026-09-02.*
...
* Visual Studio Code
  * [Salesforce Extensions for VS Code](https://github.com/forcedotcom/salesforcedx-vscode) ⭐ 1,035 | 🐛 94 | 🌐 TypeScript | 📅 2026-09-17 are the official Salesforce VS Code extensions.
...
* [Apex Commons](https://github.com/financialforcedev/fflib-apex-common) ⭐ 1,012 | 🐛 37 | 🌐 Apex | 📅 2026-09-16 - Common Apex Library supporting Apex Enterprise Patterns and much more!
...
* [Apex Commons Sample Code](https://github.com/financialforcedev/fflib-apex-common-samplecode) ⭐ 220 | 🐛 11 | 🌐 Apex | 📅 2026-09-08 - Samples application illustrating the Apex Enterprise Patterns library
  Must deploy [Apex Common ](https://github.com/financialforcedev/fflib-apex-common) ⭐ 1,012 | 🐛 37 | 🌐 Apex | 📅 2026-09-16 before deploying this library<br/> <a href="https://githubsfdeploy.herokuapp.com?owner=financialforcedev&repo=fflib-apex-common-samplecode"><img alt="Deploy to Salesforce" src="https://raw.githubusercontent.com/afawcett/githubsfdeploy/master/src/main/webapp/resources/img/deploy.png">
  </a>
...
* [SoqlXplorer](https://github.com/superfell/SoqlX) ⭐ 280 | 🐛 20 | 🌐 Objective-C | 📅 2023-08-20- SoqlXplorer is an awesome tool for developers using the Salesforce.com platform.
...
* [Salesfoce MobileSDK for Andriod](https://github.com/forcedotcom/SalesforceMobileSDK-Android) ⭐ 361 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-17- Source repository for the Salesforce Mobile SDK for Android.
