...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 504,474 | 🐛 106 | 📅 2026-09-02
...
*Inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,474 | 🐛 106 | 📅 2026-09-02 list thing. You might also like to read complete [awesome-list](https://github.com/sindresorhus/awesome) ⭐ 504,474 | 🐛 106 | 📅 2026-09-02.*
...
Read [the awesome manifesto](https://github.com/mailtoharshit/awesome-salesforce/blob/master/contributing.md) ⭐ 806 | 🐛 6 | 📅 2023-07-20 and ensure your list complies.
...
# Awesome A Note on Repo AWSomeness with stars
...
Pull requests might be left open for a period of time to let the community chime in and vouch for it.  An official repo from [aws](https://github.com/aws) or [awslabs](https://github.com/awslabs) can be removed if the community wishes.  Check out the [awesome manifesto](https://github.com/sindresorhus/awesome/blob/master/awesome.md) ⭐ 504,474 | 🐛 106 | 📅 2026-09-02.

Read Related Awesome Pages :

* [Awesome Lighting](https://github.com/mailtoharshit/awesome-lighting) ⭐ 87 | 🐛 6 | 📅 2021-10-07
* [Awesome Browser Extensions](https://github.com/mailtoharshit/awesome-browser-extensions-for-salesforce/blob/master/README.md) ⭐ 57 | 🐛 3 | 📅 2020-04-21
* [Awesome Articles](https://github.com/mailtoharshit/awesome-salesforce-articles) ⭐ 15 | 🐛 0 | 📅 2020-11-15
* [Awesome Heroku](https://github.com/mailtoharshit/awesome-heroku) ⭐ 13 | 🐛 0 | 📅 2017-03-16
...
* [HaoIDE](https://github.com/xjsender/haoide) ⭐ 198 | 🐛 21 | 🌐 Python | 📅 2022-03-30 - Sublime Plugin for Force.com
* [ApexMate](https://github.com/superfell/ApexMate) ⚠️ Archived- Apex Plugin for TextMate.
...
* Visual Studio Code
  * [Salesforce Extensions for VS Code](https://github.com/forcedotcom/salesforcedx-vscode) ⭐ 1,034 | 🐛 99 | 🌐 TypeScript | 📅 2026-09-09 are the official Salesforce VS Code extensions.
...
Read cruciated list of [Awesome-list-of-browser-extensions-of-salesforce](https://github.com/mailtoharshit/awesome-browser-extensions-for-salesforce/blob/master/README.md) ⭐ 57 | 🐛 3 | 📅 2020-04-21

### Packages and Libraries supporting salesforce

* [Apex Commons](https://github.com/financialforcedev/fflib-apex-common) ⭐ 1,012 | 🐛 36 | 🌐 Apex | 📅 2026-09-09 - Common Apex Library supporting Apex Enterprise Patterns and much more!
  Must deploy [ApexMocks](https://github.com/financialforcedev/fflib-apex-mocks) ⭐ 462 | 🐛 11 | 🌐 Apex | 📅 2026-09-07 before deploying this library.Also see [MavensMate Templates](http://andyinthecloud.com/2014/05/23/mavensmate-templates-and-apex-enterprise-patterns/)<br/> <a href="https://githubsfdeploy.herokuapp.com?owner=financialforcedev&repo=fflib-apex-common"><img alt="Deploy to Salesforce" src="https://raw.githubusercontent.com/afawcett/githubsfdeploy/master/src/main/webapp/resources/img/deploy.png">
  </a>

* [Apex mocks](https://github.com/financialforcedev/fflib-apex-mocks) ⭐ 462 | 🐛 11 | 🌐 Apex | 📅 2026-09-07 - ApexMocks is a mocking framework for the Force.com Apex language.It derives it's inspiration from the well known Java mocking framework Mockito <a href="https://githubsfdeploy.herokuapp.com?owner=financialforcedev&repo=fflib-apex-mocks"> <img alt="Deploy to Salesforce" src="https://raw.githubusercontent.com/afawcett/githubsfdeploy/master/src/main/webapp/resources/img/deploy.png"> </a>
...
* [Apex Commons Sample Code](https://github.com/financialforcedev/fflib-apex-common-samplecode) ⭐ 220 | 🐛 11 | 🌐 Apex | 📅 2026-09-08 - Samples application illustrating the Apex Enterprise Patterns library
  Must deploy [Apex Common ](https://github.com/financialforcedev/fflib-apex-common) ⭐ 1,012 | 🐛 36 | 🌐 Apex | 📅 2026-09-09 before deploying this library<br/> <a href="https://githubsfdeploy.herokuapp.com?owner=financialforcedev&repo=fflib-apex-common-samplecode"><img alt="Deploy to Salesforce" src="https://raw.githubusercontent.com/afawcett/githubsfdeploy/master/src/main/webapp/resources/img/deploy.png">
  </a>
...
* [Query.apex](https://github.com/Click-to-Cloud/Query.apex/) ⭐ 156 | 🐛 34 | 🌐 Apex | 📅 2023-12-26 - SOQL query builder on Salesforce.com platform, which supports complex conditions, field and namespace management, child relationships query, and functional programming style coding.

* [Force.com ESAPI](https://github.com/forcedotcom/force-dot-com-esapi) ⭐ 129 | 🐛 4 | 🌐 Apex | 📅 2026-06-02 - Enterprise Security API for the Apex language on the Force.com platform. This library consists of three modules - Validation, Output Encoding and Access Control(CRUD, FLS and Sharing).

* [Visualforce TableGrid](https://github.com/Up2Go/visualforce-table-grid) ⭐ 124 | 🐛 11 | 🌐 Apex | 📅 2023-10-18 - TableGrid is a free, open-source Force.com library, that provides users and developers a highly customizable, native-looking, sortable, filterable, editable Grid Visualforce component. This component can be used as an advanced, highly configurable (by developer and user) replacement of apex:pageBlockTables and Standard Related Lists </br>
...
* [Apex UML Digram Maker](https://github.com/afawcett/apex-umlcanvas) ⭐ 111 | 🐛 6 | 🌐 JavaScript | 📅 2019-01-21 - Create UML diagrams from Apex code using the Tooling API <br/>

* [R.apex](https://github.com/Click-to-Cloud/R.apex/) ⭐ 106 | 🐛 10 | 🌐 Apex | 📅 2023-02-22 - Functional library for Apex. This library, inspired by Ramda.js, offers a bunch of utility functions to manipulate Apex collections, as well as extensive support for functional programming.

* [Apex Core HttpCallout](https://github.com/financialforcedev/ffhttp-core) ⭐ 67 | 🐛 3 | 🌐 Apex | 📅 2020-06-26 - Apex HTTP Callout Framework.<br/> <a href="https://githubsfdeploy.herokuapp.com?owner=financialforcedev&repo=ffhttp-core"><img alt="Deploy to Salesforce" src="https://raw.githubusercontent.com/afawcett/githubsfdeploy/master/src/main/webapp/resources/img/deploy.png"> </a><br/>

  This library has been extended by five libraries <br/>

  * [Google Drive](https://github.com/financialforcedev/ffhttp-googledrive) ⭐ 21 | 🐛 2 | 🌐 Apex | 📅 2021-02-15
  * [Google Sheets](https://github.com/financialforcedev/ffhttp-googlesheets) ⚠️ Archived
  * [Dropbox](https://github.com/financialforcedev/ffhttp-dropbox) ⚠️ Archived
  * [Google Cloud Print](https://github.com/financialforcedev/ffhttp-googlecloudprint) ⚠️ Archived
  * [Google Mirror](https://github.com/financialforcedev/ffhttp-googlemirror) ⚠️ Archived
...
* [Apex Chainable Batch](https://github.com/rsoesemann/apex-chainable-batch) ⭐ 56 | 🐛 2 | 🌐 Apex | 📅 2024-09-04 - Apex Batches can be chained by calling the successor batch from the `finish()` method of the previous batch. But such hardcoding makes this model inflexible. It's hard to build the chain from outside, neighter from a central class nor on runtime dependant on business logic.

* [Polyforce](https://github.com/mailtoharshit/polyforce) ⭐ 29 | 🐛 0 | 📅 2015-01-16 - PolyForce is the project started as an idea with a motive create polymer applications/components that derive data from Salesforce, The idea create a robust set of polymer components that can mutually be shared with each other and on the other hand provide a working sample for developers to learn and get inspired to built more components <br/>
...
* [Workbench](https://github.com/ryanbrainard/forceworkbench) ⭐ 537 | 🐛 3 | 🌐 PHP | 📅 2026-09-05- Workbench is a powerful, web-based suite of tools designed for administrators and developers to interact with Salesforce.com organizations via the Force.com APIs.

* [SoqlXplorer](https://github.com/superfell/SoqlX) ⭐ 279 | 🐛 20 | 🌐 Objective-C | 📅 2023-08-20- SoqlXplorer is an awesome tool for developers using the Salesforce.com platform.

* [Analytics-Cloud-Dataset-Utils](https://github.com/forcedotcom/Analytics-Cloud-Dataset-Utils) ⭐ 130 | 🐛 39 | 🌐 JavaScript | 📅 2026-06-02- Utility to load external data into Analytics Cloud datasets, and transform existing datasets.
...
* [soql-parser-js](https://github.com/paustint/soql-parser-js) ⭐ 89 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-05 - JavaScript library for parsing SOQL queries, composing SOQL queries, and formatting SOQL queries.
...
* [Sweet.apex](https://github.com/Click-to-Cloud/Sweet.apex/) ⭐ 46 | 🐛 4 | 🌐 JavaScript | 📅 2018-08-12 - Sweet.apex is the next generation of Apex development, transpiling Sweet Apex(a feature-rich Apex-like code) to Apex classes.

* [Salesforce1-Dev-Guide-Setup-Package](https://github.com/forcedotcom/Salesforce1-Dev-Guide-Setup-Package) ⚠️ Archived-Salesforce1-Dev-Guide-Setup-Package
...
* [GitIgnore for Salesforce ](https://github.com/mailtoharshit/gitignore) ⭐ 32 | 🐛 0 | 📅 2017-01-20- Reusable .gitIgnore file for Salesforce or Force.com Projects
...
* [Salesforce Mobile UI - Polymer Elements for Salesforce](https://github.com/forcedotcom/mobile-ui-elements) ⚠️ Archived - Mobile UI Elements is a free, open-source Force.com (unsupported) library to simplify the development of mobile apps. The library, based on the Google’s Polymer framework, provides the fundamental building blocks for creating HTML5 apps that run well on smartphones and tablets
* [ForceServer](https://github.com/ccoenraets/force-server) ⭐ 49 | 🐛 9 | 🌐 JavaScript | 📅 2020-06-19 - It supportes a proxy and web server, ForceServer is a simple development server aimed at providing a simple and integrated developer experience when building applications that use Salesforce OAuth and REST services.
...
* [nForce](https://github.com/kevinohara80/nforce) ⚠️ Archived - nforce is a node.js salesforce REST API wrapper for force.com, database.com, and salesforce.com
...
* [Salesforce ReactJS SPA Starter](https://github.com/stomita/salesforce-reactjs-spa-starter) ⭐ 16 | 🐛 0 | 🌐 CoffeeScript | 📅 2015-02-25 - A template project to create ReactJS-based single page application on Salesforce, with automatic build script (Gulp.js)
* [ForceSpinner](https://github.com/mailtoharshit/ForceSpinner) ⭐ 8 | 🐛 0 | 🌐 CSS | 📅 2016-02-12 - Loaders/Spinner collections to leverage powerful User Experience for Salesforce Projects
* [Feather - Google Material Design Mockup for Salesforce](https://github.com/mailtoharshit/Feather/blob/master/README.md) ⭐ 7 | 🐛 0 | 🌐 CSS | 📅 2018-12-16 - Library
...
* Some other solutions from [awesome-etl list](https://github.com/pawl/awesome-etl) ⭐ 3,590 | 🐛 13 | 📅 2026-05-01.
...
* [Awesome Lightning](https://github.com/mailtoharshit/awesome-lighting) ⭐ 87 | 🐛 6 | 📅 2021-10-07: Awesome Contents for Salesforce Lightning Framework

## Salesforce Browser Extensions

* [Awesome Salesforce Browser Extensions](https://github.com/mailtoharshit/awesome-browser-extensions-for-salesforce) ⭐ 57 | 🐛 3 | 📅 2020-04-21: Collection of Awesome Browser Extensions for Salesforce

## Mobile Development with Salesforce

### Mobile SDK

* [Salesfoce MobileSDK for iOS](https://github.com/forcedotcom/SalesforceMobileSDK-iOS) ⭐ 553 | 🐛 5 | 🌐 Objective-C | 📅 2026-09-04-If you'd like to work with the source code of the SDK itself, you've come to the right place! You can browse sample app source code and debug down through the layers to get a feel for how everything works under the covers.

* [Salesfoce MobileSDK for Andriod](https://github.com/forcedotcom/SalesforceMobileSDK-Android) ⭐ 361 | 🐛 5 | 🌐 Kotlin | 📅 2026-09-04- Source repository for the Salesforce Mobile SDK for Android.
...
Contributions welcome! Read the [contribution guidelines](https://github.com/mailtoharshit/awesome-salesforce/blob/master/contributing.md) ⭐ 806 | 🐛 6 | 📅 2023-07-20 first.
